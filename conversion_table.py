...
voice_conversion_table: dict[VoiceType, dict[str, tuple[str, str]]] = {
    VoiceType.DORM: {
        # dorm
    ...
    VoiceType.SYSTEM: {
        ...
        "004": ("", "Game won"),
        "005": ("", "Game lost"),
        "006": ("", "(Demolition) One ally remaining"),
        "007": ("", "(Demolition) One enemy remaining"),
        "008": ("", "(Demolition) Bomb carrier down"),
        "009": ("", "(Demolition) Bomb dropped in point A"),
        "010": ("", "(Demolition) Bomb dropped in point B"),
        "011": ("", "(Demolition) Bomb planted"),
        "012": ("", "(Demolition) Final round of first half"),
        "013": ("", "(Demolition) Match point"),
        "014": ("", "(Demolition) Switch sides"),
        "015": ("", "(Demolition) Overtime"),
        "016": ("", "(Team Arena) 10 kills remaining to win"),
        "017": ("", "(Team Arena) 5 kills remaining to win"),
        "018": ("", "(Team Arena) 1 kill remaining to win"),
        "019": ("", "(Team Arena) 10 kills remaining (enemy team)"),
        "020": ("", "(Team Arena) 5 kills remaining (enemy team)"),
        ...
        "033": ("", "(Demolition) Countdown from 5"),
        "034": ("", "(Demolition) Attacking team (bomb carrier)"),
        "035": ("", "(Demolition) Attacking team (not the bomb carrier)"),
        "036": ("", "(Demolition) Defending team"),
        "037": ("", ""),
        "038": ("", ""),
        "039": ("", ""),
        "040": ("", ""),
        ...
        "046": ("", ""),
        "047": ("", ""),
        "048": ("", "(TDM) Warmup start"),
        "049": ("", "(TDM) Warmup about to end"),
        "050": ("", "(TDM) Countdown from 3"),
        "051": ("", "(TDM) Leading team has scored 20 points"),
        "052": ("", "(TDM) Leading team has scored 30 points"),
        "053": ("决赛阶段开始", "(TDM) Final showdown"),
        "054": ("决赛阶段开始", "(TDM) Final showdown"),
        "055": ("", "(TDM) Reverse string storm appearing"),
        "056": ("", ""),
        "057": ("", "(TDM) Team sheild activated"),
        "058": ("", "(TDM) Superstring enhancement activated"),
        "059": ("", "(TDM) Weapon enhancement activated"),
        "060": ("", ""),
        "061": ("", ""),
        "062": ("", ""),
        "063": ("", ""),
        ...
        "074": ("", "(Escort) Escort defense start"),
        "075": ("", "(Escort) Checkpoint reached"),
        "076": ("", "(Escort) Payload almost at destination"),
        "077": ("", "(Escort) Overtime"),
        "078": ("", "End of first half"),
        "079": ("", "(Crystal Mine Grab) Start"),
        "080": ("", "(Crystal Mine Grab) Warehouse defense deactivated"),
        "081": ("", "(Crystal Mine Grab) Enemy warehouse defense deactivated"),
        "082": ("", "(Crystal Mine Grab) Enemy Bablo crystal stolen"),
        "083": ("", "(Crystal Mine Grab) Bablo crystal stolen"),
        "084": ("", "(Crystal Mine Grab) Halfway to victory"),
        "085": ("", "(Crystal Mine Grab) Enemies halfway to victory"),
        "086": ("", "(Crystal Mine Grab) Almost winning"),
        "087": ("", "(Crystal Mine Grab) Enemies almost winning"),
        "088": ("", ""),
        "089": ("", ""),
        "090": ("", ""),
        "091": ("", ""),
        ...
        "114": ("", ""),
        "115": ("", ""),
        "116": ("", "(Outbreak) Countdown from 10"),
        "117": ("", "(Outbreak) Human resupplies about to arrive"),
        "118": ("", "(Outbreak) Crystalline energy crystals about to arrive"),
        "119": ("", "(Outbreak) Final stand"),
        "120": ("", "(Outbreak) Final stand"),
        "121": ("", "(Outbreak) Crystallines won"),
        "122": ("", "(Outbreak) Superstrings won"),
        "123": ("", "(Outbreak) Game end"),
        "124": ("", "Enhanced supplies dropped"),
        "125": ("", "(Demolition) Game loss"),
        "126": ("", ""),
        "127": ("", ""),
        "128": ("", ""),
        "129": ("", ""),
