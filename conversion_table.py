...
voice_conversion_table: dict[VoiceType, dict[str, tuple[str, str]]] = {
    ...
    VoiceType.SYSTEM: {
        ...
        "079": ("", "(Crystal Scramble) Start"),
        "080": ("", "(Crystal Scramble) Warehouse defense deactivated"),
        "081": ("", "(Crystal Scramble) Enemy warehouse defense deactivated"),
        "082": ("", "(Crystal Scramble) Enemy Bablo crystal stolen"),
        "083": ("", "(Crystal Scramble) Bablo crystal stolen"),
        "084": ("", "(Crystal Scramble) Halfway to victory"),
        "085": ("", "(Crystal Scramble) Enemies halfway to victory"),
        "086": ("", "(Crystal Scramble) Almost winning"),
        "087": ("", "(Crystal Scramble) Enemies almost winning"),
        "088": ("", ""),
        "089": ("", ""),
        "090": ("", ""),
        "091": ("", ""),
